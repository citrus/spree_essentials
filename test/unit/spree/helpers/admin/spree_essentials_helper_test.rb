...
class Spree::Admin::SpreeEssentialsHelperTest < ActionView::TestCase
  ...
  should "build admin contents tab" do
    assert_equal "<li class=\"tab-with-icon\"><a href=\"/admin/uploads\" class=\"icon_link with-tip icon-book\"><span class='text'>Content</span></a></li>", contents_tab
  end

  should "add selected class to admin contents tab" do
    visit "/admin/uploads"
    assert_equal "<li class=\"selected tab-with-icon\"><a href=\"/admin/uploads\" class=\"icon_link with-tip icon-book\"><span class='text'>Content</span></a></li>", contents_tab
  end
